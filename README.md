...
To aid in the optimization of these parameters I developed the [view-mongo-images.py](./face-det-rec/view-mongo-images.py) program that allows you to step through the mongodb database written to by zm-s3-uploader.js to quickly see the effect of changing parameter values. An example image generated by this program is shown below.

![Alt text](./face-det-rec/saved_images/5c4e12552e3ff70f425b170f.jpg?raw=true "example output from view-mong0-images.py")
